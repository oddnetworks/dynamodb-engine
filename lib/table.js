...
U.extend(Table.prototype, {
...

	{
		...
		order: 'STRING_VALUE', /* default = 'ascending' */
		limit: 0
	}
	query: function (params) {
		...
		var newParams = {
			...
			ScanIndexForward: params.order !== 'descending',
		...
		if (params.indexName) {
			newParams.IndexName = params.indexName;
		}
		...
		return new Promise(function (resolve, reject) {
			self.dynamodb.query(params, function (err, res) {
			});
		});
	}
});
