...
U.extend(Database.prototype, {
	...
	//   tableName: 'STRING_VALUE', /* required */
	//   attributes: { /* required */
	//     someAttributeName: 'String | Number | Boolean',
	//     /* all attributes used in keys or globalIndex keys */
	//   },
	//   keys: { /* required */
	//     hash: 'STRING_VALUE', /* required if there is not a unique range key */
	//     range: 'STRING_VALUE'
	//   },
	//   throughput: {
	//     read: 10, /* default = 10 */
	...
	createTable: function (params) {
		...
		var AttributeDefinitions = Object.keys(attributes).map(function (key) {
